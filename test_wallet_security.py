...
# -*- coding: utf-8 -*-
"""
Script de test pour le chiffrement des wallets
"""
...
print("=== Test de chiffrement des wallets ===\n")
...
try:
    ...
    from gbpbot.security.wallet_encryption import WalletEncryption, encrypt_wallet_file, decrypt_wallet_file
